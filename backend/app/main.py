...
from app.api import (
    ...
    adjuntos, catalogo_insumos, gastos_fijos, recipes,
...
async def lifespan(app: FastAPI):
    ...
    start_scheduler()  
    # Ya no se resetean contraseñas automáticamente para no afectar las pruebas del cliente
    yield
    stop_scheduler()
...
app.include_router(recipes.router, prefix="/api/recipes", tags=["Récipes Médicos"])
