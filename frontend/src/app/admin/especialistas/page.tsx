          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-white/10">
                <th className="px-6 py-5 text-left text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-400">Especialista</th>
                <th className="px-6 py-5 text-left text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-400">Especialidad</th>
                <th className="px-6 py-5 text-left text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-400">Plan / Estado</th>
                <th className="px-6 py-5 text-left text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-400">Vencimiento</th>
                <th className="px-6 py-5 text-left text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-400">Registro</th>
