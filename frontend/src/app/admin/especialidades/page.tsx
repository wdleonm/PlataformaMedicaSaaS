        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-md bg-[#130b22] border border-outline-variant/30 rounded-[40px] shadow-2xl overflow-hidden"
            >
              ...
              <form onSubmit={handleSave} className="p-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full glass-panel rounded-[2.5rem] border-none p-4 text-on-surface font-mono focus:ring-2 focus:ring-violet-500/50 outline-none"
                  />
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  <button 
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="flex-1 py-4 px-6 rounded-2xl border border-outline-variant/30 text-on-surface-variant font-bold hover:bg-surface-container-highest/50 transition-all outline-none uppercase tracking-widest text-xs"
                  >
                    Cancelar
                  </button>
                  <button 
