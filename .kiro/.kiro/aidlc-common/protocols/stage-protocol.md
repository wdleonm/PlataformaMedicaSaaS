...
`.kiro/aidlc-common/protocols/stage-protocol-construction.md`.
...
.kiro/tools/aidlc-utility.ts scope-table` when you need those
...
`.kiro/aidlc-common/protocols/stage-protocol-ensemble.md`.
...
.kiro/tools/aidlc-utility.ts scope-table` for the current
...
`.kiro/aidlc-common/protocols/stage-protocol-reviewer.md`.
